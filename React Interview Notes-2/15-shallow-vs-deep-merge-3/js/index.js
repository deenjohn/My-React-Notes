      ...
      */
      ...
      _this.setState(function (prevState) {
        return _extends({}, prevState, {
          someProperty: _extends({}, prevState.someProperty, {
            someOtherProperty: _extends({}, prevState.someProperty.someOtherProperty, {
              anotherProperty: _extends({}, prevState.someProperty.someOtherProperty.anotherProperty, {
                flag: true
              })
            })
          })
      ...
      var clone = JSON.parse(JSON.stringify(_this.initialState));
      _this.setState(clone);
